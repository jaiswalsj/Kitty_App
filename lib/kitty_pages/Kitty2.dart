...
class KittyPrc extends StatefulWidget {
  const KittyPrc({Key? key}) : super(key: key);

  @override
  State<KittyPrc> createState() => _KittyPrcState();
}

class _KittyPrcState extends State<KittyPrc> {
  @override
  Widget build(BuildContext context) {
    return  Column(
      children: [
        ...
        Divider(thickness: 1,indent: 20,endIndent: 30,color: App_colors.pink,),
